...
private:
    ...
    NcDim *recDim, *NvDim, *dofDim, *NvnDim, *ncDim, *nc2Dim, *boxDim, *unitDim, *cvDim, *vnDim; //!< NcDims we'll use
    NcVar *posVar, *forceVar, *vneighVar, *vcneighVar, *directorVar, *BoxMatrixVar, *timeVar, *meanqVar, *actualp0Var, *actuala0Var, *actuals0Var; //!<NcVars we'll use
    NcVar *cellPosVar, *cellTypeVar, *cellVerVar, *cellVerNumVar;
