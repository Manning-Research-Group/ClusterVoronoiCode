#ifndef gradientinteractions_H
#define gradientinteractions_H
...
*/
class gradientinteractions : public simpleEquationOfMotion
    {
    public:
        //!base constructor sets the default time step size
        gradientinteractions(){deltaT = 0.01; GPUcompute =true;Timestep = 0;};

        //!additionally set the number of particles andinitialize things
        gradientinteractions(int N);
        ...
        //!Set state?
        //virtual void setConcState(shared_ptr<VoronoiQuadraticEnergyWithConc>) STATE;
    ...
    protected:
        ...
        Dscalar mu;
        GPUArray<Dscalar2> alignArr;
        GPUArray<Dscalar> gradArr;
